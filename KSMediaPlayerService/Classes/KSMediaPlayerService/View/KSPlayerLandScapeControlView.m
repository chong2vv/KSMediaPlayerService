//
//  KSPlayerLandScapeControlView.m
//  ArtVideoWB
//
...
@interface KSPlayerLandScapeControlView () <ZFSliderViewDelegate>
/// 顶部工具栏
...
@implementation KSPlayerLandScapeControlView
...
- (void)layoutSubviews {
    ...
    min_x = self.isUserControlEnable ? self.playOrPauseBtn.right + 4 : min_margin;
    min_y = 0;
    min_w = 62;
    min_h = 30;
...
- (void)playOrPause {
    ...
    self.controlPlayOrPause(self.playOrPauseBtn.isSelected);
}
...
- (void)setIsUserControlEnable:(BOOL)isUserControlEnable {
    ...
    self.playOrPauseBtn.hidden = !isUserControlEnable;
    self.slider.isHideSliderBlock = !isUserControlEnable;
    self.lockBtn.hidden = !isUserControlEnable;
}
